...
import { useAddTransaction } from '../../requestsQL/useTransaction'
...
export const Form: React.FC<{ getData: any }> = ({ getData }) => {
    ...
    return (
        <form onSubmit={formik.handleSubmit} className="flex flex-row w-4/5 space-x-4">
            <input id="value" placeholder="Importo" className="w-1/3 border border-dark rounded-2xl p-2 text-dark font-semibold" value={formik.values.value} onChange={formik.handleChange} />
